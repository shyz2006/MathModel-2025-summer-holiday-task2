...
file2 = r"E:\存放桌面\数学建模资料汇总数学建模BOOM\2025暑期任务-2\C题\附件2.xlsx"  # 修改为附件2的实际文件路径
...
model.addConstrs(
    (X[t, i, j, k] == 0
    for t in range(T) for i in range(I) for j in range(35) for k in range(37, 41)
    )
